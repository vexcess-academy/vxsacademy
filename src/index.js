...
const projectTree = {
    ...
    "/API/": {
        ":ACTION": (path, out, data) => {
            ...
            // ignore
            if (data.request.headers.origin !== "https://vxsacademy.org" && ["signup", "login", "create_program", "save_program", "delete_program", "like_program", "update_profile", "compile_cpp", "sign_out"].includes(path.slice(5))) {
                allowRequest = false;
            }
