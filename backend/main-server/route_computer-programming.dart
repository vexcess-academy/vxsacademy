    ...
    "*": (AP path, AO out, AD data) async {
        try {
            ...
            if (programData == null) {
                ...
                String webpageCode;
                final thumbnailURL = isKAProgram ? "https://www.khanacademy.org/computer-programming/i/${lazySanitize(programData["id"].substring(3))}/latest.png" : "/CDN/programs/${programData["id"]}.jpg";
